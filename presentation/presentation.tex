...
\begin{frame}{Research issue}
  ...
  % TODO: Ajouter une courbe bidon représentant la taille des éléments et la taille du CRDT

  \begin{center}
    \emph{How to reduce the overhead introduced by the data structure ?}
  \end{center}

  \begin{block}{Proposition}
    \begin{itemize}
      \item Reassign shorter identifiers in a fully distributed manner
      \item Focus on one \ac{CRDT}
    \end{itemize}
  \end{block}
\end{frame}
