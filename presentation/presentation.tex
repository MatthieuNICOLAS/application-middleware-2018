  ...
  \begin{columns}
    \begin{column}{0.65\textwidth}
      \begin{tikzpicture}
        ...
        \draw<1,3,5>[shorten >=3pt, shorten <=3pt]
          (A) to[bend right] (B)
          (B) to[bend right] (C)
          (C) to[bend right] (A);

        \draw<2>[shorten >=3pt, shorten <=3pt, ->] (A) to[bend right] (B);
        \draw<2>[shorten >=3pt, shorten <=3pt, <-] (C) to[bend right] (A);
        \draw<2>[shorten >=3pt, shorten <=3pt] (B) to[bend right] (C);

        \draw<4>[shorten >=3pt, shorten <=3pt, <-] (A) to[bend right] (B);
        \draw<4>[shorten >=3pt, shorten <=3pt, <->] (B) to[bend right] (C);
        \draw<4>[shorten >=3pt, shorten <=3pt, <-] (C) to[bend right] (A);
