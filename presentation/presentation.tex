...
\begin{frame}{Renaming mechanism}
  ...
  \begin{figure}
    ...
    \includegraphics[scale=0.11]{img/renaming.png}<5-5>
...
\begin{frame}{Conclusion}
  \begin{itemize}
    \item Propose a distributed renaming mechanism for \emph{LogootSplit}
    \item Allows to reset the footprint of the \ac{CRDT} without coordination
